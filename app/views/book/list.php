        ...
        <div class="row" id="statebar">
          <div class="span12">
            ...
            <div id="orderBy" class="btn-group" data-toggle="buttons-radio">
              <a href="<?php echo base_url('book/lists/'.$sid.'/'.$cid.'/2');?>" class="btn">价格 <i class="icon-arrow-up"></i></a>
              <a href="<?php echo base_url('book/lists/'.$sid.'/'.$cid.'/1');?>" class="btn">发布时间 <i class="icon-arrow-up"></i></a>
              <a href="<?php echo base_url('book/lists/'.$sid.'/'.$cid.'/3');?>" class="btn">出版时间 <i class="icon-arrow-up"></i></a>              
            </div>
